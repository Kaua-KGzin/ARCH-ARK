...
export function generateWeeklyMissions(): Mission[] {
  ...
  return [
    { id: generateId(), title: 'Guerreiro Semanal', description: 'Complete 5 treinos esta semana', category: 'exercise', type: 'weekly', xpReward: 400, goldReward: 200, itemReward: SCROLLS[4], status: 'active', progress: 0, target: 5, unit: 'treinos', icon: '🏋️', expiresAt: nextWeek.toISOString(), difficulty: 'C' },
    { id: generateId(), title: 'Maratona de Estudos', description: 'Acumule 10 horas de estudo', category: 'study', type: 'weekly', xpReward: 500, goldReward: 250, itemReward: SCROLLS[0], status: 'active', progress: 0, target: 600, unit: 'minutos', icon: '🎓', expiresAt: nextWeek.toISOString(), difficulty: 'B' },
...
export function generateMonthlyMissions(): Mission[] {
  ...
  return [
    { id: generateId(), title: 'Devorador de Livros', description: 'Leia um livro completo (ou 200 páginas)', category: 'habit', type: 'monthly', xpReward: 1000, goldReward: 500, itemReward: SCROLLS[1], status: 'active', progress: 0, target: 200, unit: 'páginas', icon: '📕', expiresAt: nextMonth.toISOString(), difficulty: 'B' },
    { id: generateId(), title: 'Campeão do Mês', description: 'Complete 20 treinos no mês', category: 'exercise', type: 'monthly', xpReward: 1500, goldReward: 750, itemReward: SCROLLS[3], status: 'active', progress: 0, target: 20, unit: 'treinos', icon: '🏆', expiresAt: nextMonth.toISOString(), difficulty: 'A' },
  ]
}
...
export function generateDungeons() {
  return [
    {
      id: 'dungeon-1', name: 'Masmorra do Conhecimento', description: 'Prove seu comprometimento com os estudos', rank: 'D' as const, timeLimit: 7, xpReward: 500, goldReward: 300, itemRewards: [SCROLLS[0]], isCompleted: false, isActive: false, progress: 0,
      missions: [
    ...
    {
      id: 'dungeon-2', name: 'Templo do Guerreiro', description: 'Uma semana de treinos intensos', rank: 'C' as const, timeLimit: 7, xpReward: 800, goldReward: 500, itemRewards: [SCROLLS[4]], isCompleted: false, isActive: false, progress: 0,
      missions: [
    ...
    {
      id: 'dungeon-3', name: 'Citadela da Disciplina', description: 'Semana sem procrastinação', rank: 'B' as const, timeLimit: 7, xpReward: 1200, goldReward: 700, itemRewards: [SCROLLS[1], SCROLLS[2]], isCompleted: false, isActive: false, progress: 0,
      missions: [
...
export function generateBosses() {
  return [
    {
      id: 'boss-1', name: 'Procrastinação', description: 'O maior inimigo da evolução.', icon: '😴', hp: 100, maxHp: 100, isDefeated: false, xpReward: 1000, goldReward: 600, itemReward: SCROLLS[3],
      missions: [
    ...
    {
      id: 'boss-2', name: 'Sedentarismo', description: 'Torne o exercício um hábito inabalável.', icon: '🛋️', hp: 150, maxHp: 150, isDefeated: false, xpReward: 1500, goldReward: 900, itemReward: SCROLLS[4],
      missions: [
